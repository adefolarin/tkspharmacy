    ...
    <div class="about-doctors-area tedd">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="eye-list-lf teart title">
                        <h4>TKS Clinical Services</h4>
                        <p>At TKS, we are dedicated to providing high-quality, patient-centered clinical services to our community. Our team of experienced healthcare professionals is committed to delivering compassionate and comprehensive care to address your unique needs.</p>
                        <div class="imgg">
           ...
           <div class="eye-list-lf">
                        <h3>TKS Clinic Services. Test and treatment of Minor ailments:</h3>
                        <div class="llff">
...
<li><a href="#"><i class="icofont-arrow-right"></i> UTI
                                ...
                                <li><a href="#"><i class="icofont-arrow-right"></i> Birth Control
</a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Yeast Infection
                                        </a></li>
                            ...
                            <ul>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Covid-19</a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Acne</a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Strept throat
                                        </a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Conjunctivitis (Pink eye)</a></li>

                            
                            <li><a href="#"><i class="icofont-arrow-right"></i>Medication refills</a></li>
