            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero-about-text text-center">
                        ...
                        <h4><span>Home / Service / </span> Pharmaceutical Community Services</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="eye-list-lf">
                        ...
                        <div class="llff">
                            ...
                            <ul>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Prescription filling and refills</a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Home vaccination service
</a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>New order refills
                                        </a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Clinical services
                                        </a></li>

                            </ul>

                            <ul>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Medication Therapy Management</a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Pharmacy Medical consultation</a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Travel Consultation
                                        </a></li>
                                <li><a href="#"><i class="icofont-arrow-right"></i>Durable Medical Equipment</a></li>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="work-tab-text">
                                    <h4>Your health wellness is our priority </h4>
                                    <p>You can refill you prescription at the comfort of your home with TKS online form </p>
