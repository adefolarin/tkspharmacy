                ...
                <div class="col-lg-8">
                    <div class="blog-form-area">
                        ...
                        <h3>Transfer RX Request Form</h3>
                            ...
                            <input type="text" name="refills_pharmname" id="refills_phramname" value="" required>
                            <label>Phone Number of Tranfering Pharmacy Name</label>
                            <input type="text" id="refills_pharmnum" name="refills_pharmnum" value="" required>
                            <label>RX Number</label>
                            <input type="text" id="refills_rxnum" name="refills_rxnum" value="" required>
                            <label>Name of Medication</label>
                            <input type="text" id="refills_med" name="refills_med" value="" required>
                            <label>Other Special Note</label>
                            <textarea cols="30" rows="10" name="refills_note" id="refills_note" required></textarea>
